<template>
  <nav style="background:#333;color:#fff;padding:12px;">
    ...
    <a @click.prevent="$router.push('/restaurantesViewOnly')" href="#" style="color:#fff;margin-right:12px;">Restaurantes</a>
    ...
    <a @click.prevent="$router.push('/restaurants')" href="#" style="color:#fff;margin-right:12px;">Meus Restaurantes</a>
  </nav>
</template>
